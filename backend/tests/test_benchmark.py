...
DATASET_LGPD = [
    ...
    # =========================================================================
    ("Considerando o processo 56478.000012/2026-05 da CGU, tal solicitação não se enquadra em informação pessoal sensível.", False, "Processo CGU - referência administrativa", "e-SIC Real"),
    ...
    ("SEI 00040-00098765/2025-00", False, "Processo SEI sem contexto de posse", "Protocolo Extra"),
    ("Protocolo nº 2025/001234", False, "Protocolo ano", "Protocolo Extra"),
    ("Referência: proc. 12345/2025", False, "Processo referência genérica", "Protocolo Extra"),

      ...
      <div className="gov-card bg-gradient-to-br from-warning/5 to-warning/10 border-warning/20">
        ...
        <div className="p-3 bg-muted/50 rounded-lg text-sm text-muted-foreground space-y-2">
          ...
          <div className="pt-2 border-t border-muted-foreground/20">
            <strong className="text-foreground">✓ Conformidade LGPD e LAI:</strong> Motor para identificação de dados pessoais sensíveis conforme Lei Geral de Proteção de Dados (LGPD) e Lei de Acesso à Informação (LAI). Zero falsos negativos garante que nenhum dado pessoal escape da análise, protegendo os direitos dos titulares dos dados.
          </div>
        </div>
      </div>
